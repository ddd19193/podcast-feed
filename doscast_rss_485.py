#!/usr/bin/env python3
"""
doscast_rss_485.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "485"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_485.xml"
STATE_FILE = "state_doscast_485.json"
REQUEST_TIMEOUT = 20
