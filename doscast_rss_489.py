#!/usr/bin/env python3
"""
doscast_rss_489.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "489"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_489.xml"
STATE_FILE = "state_doscast_489.json"
REQUEST_TIMEOUT = 20
