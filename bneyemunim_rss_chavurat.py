#!/usr/bin/env python3
"""
bneyemunim_rss.py — בונה ומעדכן פיד RSS מדף "חבורת אמן - סיפור בהמשכים"
...
PAGE_URL = "https://www.bneyemunim.co.il/%d7%97%d7%91%d7%95%d7%a8%d7%aa-%d7%90%d7%9e%d7%9f-%d7%a1%d7%99%d7%a4%d7%95%d7%a8-%d7%91%d7%94%d7%9e%d7%a9%d7%9b%d7%99%d7%9d/"

OUTPUT_XML = "feed_bneyemunim_chavurat.xml"
STATE_FILE = "state_bneyemunim_chavurat.json"
REQUEST_TIMEOUT = 20
...
<rss version="2.0"
  ...
  <channel>
    <title>בני אמונים - חבורת אמן - סיפור בהמשכים</title>
    <description>חבורת אמן - סיפור בהמשכים - bneyemunim.co.il</description>
