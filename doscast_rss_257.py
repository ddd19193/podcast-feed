#!/usr/bin/env python3
"""
doscast_rss_257.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "257"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_257.xml"
STATE_FILE = "state_doscast_257.json"
REQUEST_TIMEOUT = 20
