#!/usr/bin/env python3
"""
doscast_rss_121.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "121"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_121.xml"
STATE_FILE = "state_doscast_121.json"
REQUEST_TIMEOUT = 20
