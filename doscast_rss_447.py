#!/usr/bin/env python3
"""
doscast_rss_447.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "447"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_447.xml"
STATE_FILE = "state_doscast_447.json"
REQUEST_TIMEOUT = 20
