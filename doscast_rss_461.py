#!/usr/bin/env python3
"""
doscast_rss_461.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "461"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_461.xml"
STATE_FILE = "state_doscast_461.json"
REQUEST_TIMEOUT = 20
