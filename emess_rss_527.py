#!/usr/bin/env python3
"""
emess_rss_527.py — בונה ומעדכן פיד RSS לתוכנית 527 באתר emess.co.il,
...
מבנה שאומת מול נתונים אמיתיים מהאתר:
  ...
  - ניתן לסנן ישירות: /wp-json/wp/v2/aryo_programs?tax_broadcasters=527
  - קובץ השמע של כל פרק נמצא בשדה audio_in_content[0].audio_file

הרצה:
    pip install requests
    python3 emess_rss_527.py
"""
...
TERM_ID = 527                     # מזהה התוכנית
OUTPUT_XML = "feed_527.xml"
STATE_FILE = "state_527.json"
