#!/usr/bin/env python3
"""
emess_rss_394.py — בונה ומעדכן פיד RSS לתוכנית 394 באתר emess.co.il,
...
מבנה שאומת מול נתונים אמיתיים מהאתר:
  ...
  - ניתן לסנן ישירות: /wp-json/wp/v2/aryo_programs?tax_broadcasters=394
  - קובץ השמע של כל פרק נמצא בשדה audio_in_content[0].audio_file

הרצה:
    pip install requests
    python3 emess_rss_394.py
"""
...
TERM_ID = 394                     # מזהה התוכנית
OUTPUT_XML = "feed_394.xml"
STATE_FILE = "state_394.json"
