#!/usr/bin/env python3
"""
emess_rss_447.py — בונה ומעדכן פיד RSS לתוכנית 447 באתר emess.co.il,
...
מבנה שאומת מול נתונים אמיתיים מהאתר:
  ...
  - ניתן לסנן ישירות: /wp-json/wp/v2/aryo_programs?tax_broadcasters=447
  - קובץ השמע של כל פרק נמצא בשדה audio_in_content[0].audio_file

הרצה:
    pip install requests
    python3 emess_rss_447.py
"""
...
TERM_ID = 447                     # מזהה התוכנית
OUTPUT_XML = "feed_447.xml"
STATE_FILE = "state_447.json"
