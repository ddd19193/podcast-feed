#!/usr/bin/env python3
"""
doscast_rss_475.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "475"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_475.xml"
STATE_FILE = "state_doscast_475.json"
REQUEST_TIMEOUT = 20
