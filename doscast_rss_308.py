#!/usr/bin/env python3
"""
doscast_rss_308.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "308"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_308.xml"
STATE_FILE = "state_doscast_308.json"
REQUEST_TIMEOUT = 20
