#!/usr/bin/env python3
"""
doscast_rss_465.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "465"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_465.xml"
STATE_FILE = "state_doscast_465.json"
REQUEST_TIMEOUT = 20
