#!/usr/bin/env python3
"""
emess_rss_506.py — בונה ומעדכן פיד RSS לתוכנית 506 באתר emess.co.il,
...
מבנה שאומת מול נתונים אמיתיים מהאתר:
  ...
  - ניתן לסנן ישירות: /wp-json/wp/v2/aryo_programs?tax_broadcasters=506
  - קובץ השמע של כל פרק נמצא בשדה audio_in_content[0].audio_file

הרצה:
    pip install requests
    python3 emess_rss_506.py
"""
...
TERM_ID = 506                     # מזהה התוכנית
OUTPUT_XML = "feed_506.xml"
STATE_FILE = "state_506.json"
