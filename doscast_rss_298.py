#!/usr/bin/env python3
"""
doscast_rss_298.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "298"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_298.xml"
STATE_FILE = "state_doscast_298.json"
REQUEST_TIMEOUT = 20
