#!/usr/bin/env python3
"""
kolhalashon_rss_1920.py — בונה ומעדכן פיד RSS לשיעורים של רב/עמוד מסוים
...
הרצה:
    ...
    python3 kolhalashon_rss_1920.py
"""
...
GENERAL_ID = 1920                 # מזהה הרב/העמוד
NUM_OF_ROWS = 24                  # כמות שיעורים לעמוד (כמו שהאתר עצמו משתמש)
MAX_PAGES = 100                   # תקרת בטיחות

OUTPUT_XML = "feed_kolhalashon_1920.xml"
STATE_FILE = "state_kolhalashon_1920.json"
REQUEST_TIMEOUT = 20
