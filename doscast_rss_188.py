#!/usr/bin/env python3
"""
doscast_rss_188.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "188"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_188.xml"
STATE_FILE = "state_doscast_188.json"
REQUEST_TIMEOUT = 20
