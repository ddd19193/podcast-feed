#!/usr/bin/env python3
"""
doscast_rss_419.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "419"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_419.xml"
STATE_FILE = "state_doscast_419.json"
REQUEST_TIMEOUT = 20
