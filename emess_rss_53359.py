#!/usr/bin/env python3
"""
emess_rss_53359.py — בונה ומעדכן פיד RSS לתוכנית 53359 באתר emess.co.il,
...
מבנה שאומת מול נתונים אמיתיים מהאתר:
  ...
  - ניתן לסנן ישירות: /wp-json/wp/v2/aryo_programs?tax_broadcasters=53359
  - קובץ השמע של כל פרק נמצא בשדה audio_in_content[0].audio_file

הרצה:
    pip install requests
    python3 emess_rss_53359.py
"""
...
TERM_ID = 53359                     # מזהה התוכנית
OUTPUT_XML = "feed_53359.xml"
STATE_FILE = "state_53359.json"
