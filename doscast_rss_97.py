#!/usr/bin/env python3
"""
doscast_rss_97.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "97"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_97.xml"
STATE_FILE = "state_doscast_97.json"
REQUEST_TIMEOUT = 20
