#!/usr/bin/env python3
"""
doscast_rss_448.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "448"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_448.xml"
STATE_FILE = "state_doscast_448.json"
REQUEST_TIMEOUT = 20
