#!/usr/bin/env python3
"""
doscast_rss_438.py — בונה ומעדכן פיד RSS לפודקאסט "המזרחן" (podcast_id 121)
...
PODCAST_ID = "438"                # מזהה הפודקאסט

OUTPUT_XML = "feed_doscast_438.xml"
STATE_FILE = "state_doscast_438.json"
REQUEST_TIMEOUT = 20
